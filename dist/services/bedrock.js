...
function buildPrompt(conditions, ruleBasedRec) {
...
function parseBedrockResponse(content) {
    ...
    try {
        ...
        if (typeof parsed.recommendedInches !== 'number' ||
